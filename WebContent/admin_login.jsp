...
<table  width="90%" border="1" align="center" cellpadding="8" cellspacing="8" rules="none" >
  <tr>
    <td height="94" colspan="2" align="center" valign="top" bgcolor="#143FA7"><h1><img src="images/hd.jpg" width="962" height="192" /></h1></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="245" valign="top"><img src="images/compass.jpg" width="250" height="250" /><br />      <img src="images/political-party-elections.jpg" width="250" height="250" /><br /></td>
    <td width="768" height="396" valign="top"><p>&nbsp;</p>      <p>&nbsp;</p>
      <table  rules="none" width="540" border="1" align="center" cellpadding="6" cellspacing="6" bordercolor="#FDCB50">
      <tr>
        <td colspan="2" align="center"><h1>Admin Login</h1></td>
      </tr>
      <tr>
        <td width="171" height="43">Administrator Name</td>
        <td width="236"><span id="sprytextfield1">
      ...
      <tr>
        ...
        <td><input type="submit" name="Submit" value="Submit" />
          <%
			  ...
			  out.println(session.getAttribute("ch"));
			  session.setAttribute("ch",null);
			  %>
          </a></td>
      </tr>
  ...
  <tr>
    <td height="36" colspan="2" align="center" valign="top" bgcolor="#FF9326">Copyright &copy; 2019  Voting Inc.&nbsp;<a target="_blank" rel="nofollow" href="http://concept9.ca/"></a></td>
  </tr>
</table>
</form>
