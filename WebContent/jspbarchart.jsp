...
int  vno=90;
	...
	while(rs.next())
			{
			 data.setValue(rs.getString(3), new Double(rs.getString(2)));	
              ...
              final File file1 = new File("D:/AdvanceJavaWorkSpace/AdvanceOnLineVoatingMachineSystemUsingWebcam/WebContent/piechart.png");
	...
	background-color: #000;
           ...
           border="4" usemap="#chart" /></td>
                ...
                <tr>
                  <td height="21" align="center" bgcolor="#5555FF"><h2>&nbsp;</h2></td>
                </tr>
              </table>
            </form>
            </body>
