...
<body>
<form id="form1" name="form1" method="post" action="userlogin_code.jsp">
<table  width="90%" border="1" align="center" cellpadding="8" cellspacing="8" rules="none" >
  <tr>
    <td height="94" colspan="2" align="center" valign="top" bgcolor="#133EA6"><h1><img src="images/hd.jpg" width="962" height="192" /></h1></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="768" height="396" valign="top" bgcolor="#FFFFFF"><h2 itemprop="name">&nbsp;</h2>
      <table width="511" height="245" border="1" align="center" cellpadding="7" cellspacing="7"  rules="none">
        <tr>
          <td colspan="2" align="center" bgcolor="#FFFFFF"><h2>User Login</h2></td>
        </tr>
        <tr>
          <td width="119" height="38" align="left">Aadhaar Number</td>
          <td width="373"><span id="sprytextfield1">
        ...
        <tr>
          ...
          <td bgcolor="#99FF66"><input type="submit" name="Submit" value="Submit" /></td>
        </tr>
        <tr> </tr>
        <tr> </tr>
        <tr> </tr>
